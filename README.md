...
[ⓘ Более подробно почему мы выбрали WSL2 + Docker вместо Vagrant](https://github.com/presdes/8-03-hw_pre/blob/main/WSL2_Docker_VS_Vagrant.md "Включает сравнение по производительности, безопасности и проблеме двойной виртуализации")
